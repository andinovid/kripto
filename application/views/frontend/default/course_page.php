    ...
    <div class="container-fluid page__container">
      <div class="d-flex flex-column">
        ...
        <div class="d-flex align-items-center mb-3">
          <div class="mr-3">
            <img src="<?php echo base_url() . 'assets/frontend/default/assets/images/logos/rails.white.svg' ?>" width="100" alt="rails logo">
          </div>
          <div>
            <h1 class="text-white mb-0"><?php echo $course_details['title']; ?></h1>
            <p class="lead text-white"><?php echo $course_details['short_description']; ?> </p>
            <div class="my-2 text-white d-flex">
              <strong class="mr-4 ">
                <i class="material-icons icon-16pt icon-light">person</i> Created by
                <a style="color: #FFF;" href="<?php echo site_url('home/instructor_page/' . $course_details['user_id']); ?>">
                  <?php echo $instructor_details['first_name'] . ' ' . $instructor_details['last_name']; ?>
                </a>
              </strong>
              <strong class="mr-4 ">
                <i class="material-icons icon-16pt icon-light">weekend</i>
                <?php echo ucfirst($course_details['level']); ?>
              </strong>
              <strong>
                <i class="material-icons icon-16pt icon-light">watch_later</i>
                <?php
  ...
  <div class="container-fluid page__container">
    <div class="row">
      <div class="col-md-4 order-12">
        <div class="card card-margin-md-negative-40 make-me-sticky">
      ...
      <div class="col-md-8">
        <div class="card">
          <div class="card-header card-header-large bg-white">
            <h1 class="card-header__title"><?php echo site_phrase('description'); ?></h1>
          </div>
          <div class="card-body">
            <p class="mb-3">
        ...
        <div class="card">
          <div class="what-you-get-box">
            <div class="card-header card-header-large bg-white">
              <h1 class="card-header__title"><?php echo site_phrase('what_will_i_learn'); ?>?</h1>
            </div>
            <div class="card-body">
          ...
          <div class="course-curriculum-box">
            <div class="course-curriculum-title clearfix">
              <div class="card-header card-header-large bg-white d-flex align-items-center">
                <div class="flex">
                  <h4 class="card-header__title"><?php echo site_phrase('curriculum_for_this_course'); ?></h4>
                </div>
                <div class="ml-auto">
